...
[+] Version 8891689 , developed by 8891689
[+] Mode puzzle
...
[+] -- from : 0x1
[+] -- to   : 0xffffff
[+] Allocating memory for 1 elements: 0.01 MB
...
[+] Version 8891689 , developed by 8891689
[+] Mode brain
[+] Search compress and uncompress
[+] Thread : 1
[+] Allocating memory for 14 elements: 0.01 MB
[+] Bloom filter for 14 elements.
[+] Loading data to the bloomfilter total: 0.00 MB
[+] Sorting data ... done! 14 values were loaded and sorted
...
addr65: a9dbd7c2b5bf44e18c5f7fa994ad29eae2da973b <- fa3b4635d18025c0cfec4902cd75392390c0b0a4fcbc55b2ccf056fb7de167fe
[+] Total 21.54s ~ 0.14M it/s ~ 2 / 2,944,000^C
...
8.wc -l linux advanced command can query the total number of lines, for example: wc -l target.txt, find the number of lines in the file target.txt, and output 14 target.txt
...
```
cat target.txt | ./Brainmk -m bloom -n 14 -o target.blf
creating bloom filter: n = 14 | p = 1:1,000,000,000 | m = 603 (0.0 MB)
added 14 items; saving to target.blf
